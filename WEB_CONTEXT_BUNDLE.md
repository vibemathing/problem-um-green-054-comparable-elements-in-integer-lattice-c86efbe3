...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-054-comparable-elements-in-integer-lattice-c86efbe3-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-054"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-054-comparable-elements-in-integer-lattice-c86efbe3-v1",
      "problem_contract_sha256": "e013cf805ad3a0214a20bc4218bbc9c7d69e86c1397f71d39591176c2667cd7b",
      "problem_id": "problem:um-green-054-comparable-elements-in-integer-lattice-c86efbe3",
      "route_id": "route:um-green-054-comparable-elements-in-integer-lattice-c86efbe3-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-054-comparable-elements-in-integer-lattice-c86efbe3-source-fidelity-01",
      "graph_id": "graph:um-green-054-comparable-elements-in-integer-lattice-c86efbe3-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-054-comparable-elements-in-integer-lattice-c86efbe3-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-054-comparable-elements-in-integer-lattice-c86efbe3-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Consider a set $S \\subset [N]^3$ with the property that any two distinct elements $s, s'$ of $S$ are comparable (in the coordinatewise partial order). Is $|S| \\leq N^{2-\\delta}$ for some $\\delta > 0$?"
          },
          "statement_sha256": "8c8df1d65554a7242a1d59e2e981ea6b79008ffa95f6426cc1833ecacca8c27f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-054-comparable-elements-in-integer-lattice-c86efbe3-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-054-comparable-elements-in-integer-lattice-c86efbe3-root",
      "route_id": "route:um-green-054-comparable-elements-in-integer-lattice-c86efbe3-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-054-e37b28d9f0fa",
        "url": "https://www.unsolvedmath.com/problems/GREEN-054"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
